...
def get_args():
    ...
    parser.add_argument("--train_path", type = str, default = global_configs.TRAIN_FOLDER)
    parser.add_argument("--test_path", type = str, default = global_configs.TEST_FOLDER)
